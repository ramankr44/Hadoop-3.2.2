...
###
#
export HDFS_NAMENODE_USER=gradmener
export HDFS_DATANODE_USER=gradmener
export HDFS_SECONDARYNAMENODE_USER=gradmener
export YARN_RESOURCEMANAGER_USER=gradmener
export YARN_NODEMANAGER_USER=gradmener
